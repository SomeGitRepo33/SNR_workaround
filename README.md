...
При использовании теперь неободимо ВСЕГДА при использовании ios.py указывать ansible_become: yes и ansible_become_method: enable, соответственно у пользователя ДОЛЖНЫ быть права на переход в enable_mode.
